...
public class KlangAdditiveExprImpl extends ASTWrapperPsiElement implements KlangAdditiveExpr {

  public KlangAdditiveExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangMultiplicativeExpr> getMultiplicativeExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangMultiplicativeExpr.class);
  }
