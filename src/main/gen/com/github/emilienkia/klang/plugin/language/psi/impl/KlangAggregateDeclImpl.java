...
public class KlangAggregateDeclImpl extends KlangNamedDeclMixin implements KlangAggregateDecl {
  ...
  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitAggregateDecl(this);
  }
  ...
  @Override
  @Nullable
  public KlangBaseClause getBaseClause() {
    return findChildByClass(KlangBaseClause.class);
  }

  @Override
  @NotNull
  public List<KlangDeclaration> getDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangDeclaration.class);
  }
