...
public class KlangAliasDeclImpl extends ASTWrapperPsiElement implements KlangAliasDecl {

  public KlangAliasDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KlangSoftAliasDecl getSoftAliasDecl() {
    return findChildByClass(KlangSoftAliasDecl.class);
  }

  @Override
  @Nullable
  public KlangTypedefDecl getTypedefDecl() {
    return findChildByClass(KlangTypedefDecl.class);
  }
