...
public class KlangAssignmentExprImpl extends ASTWrapperPsiElement implements KlangAssignmentExpr {

  public KlangAssignmentExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KlangAssignmentExpr getAssignmentExpr() {
    return findChildByClass(KlangAssignmentExpr.class);
  }

  @Override
  @Nullable
  public KlangAssignmentOperator getAssignmentOperator() {
    return findChildByClass(KlangAssignmentOperator.class);
  }
