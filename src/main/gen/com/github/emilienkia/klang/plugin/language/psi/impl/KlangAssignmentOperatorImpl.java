...
public class KlangAssignmentOperatorImpl extends ASTWrapperPsiElement implements KlangAssignmentOperator {

  public KlangAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
