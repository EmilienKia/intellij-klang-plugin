...
public class KlangBaseClauseImpl extends ASTWrapperPsiElement implements KlangBaseClause {

  public KlangBaseClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitBaseClause(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangBaseSpec> getBaseSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangBaseSpec.class);
  }
