...
public class KlangBaseSpecImpl extends ASTWrapperPsiElement implements KlangBaseSpec {

  public KlangBaseSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitBaseSpec(this);
  }
