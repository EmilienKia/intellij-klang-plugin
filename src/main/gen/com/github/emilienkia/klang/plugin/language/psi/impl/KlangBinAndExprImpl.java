...
public class KlangBinAndExprImpl extends ASTWrapperPsiElement implements KlangBinAndExpr {

  public KlangBinAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitBinAndExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangEqualityExpr> getEqualityExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangEqualityExpr.class);
  }
