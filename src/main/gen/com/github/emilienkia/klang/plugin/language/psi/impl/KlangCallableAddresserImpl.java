...
public class KlangCallableAddresserImpl extends ASTWrapperPsiElement implements KlangCallableAddresser {

  public KlangCallableAddresserImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitCallableAddresser(this);
  }
