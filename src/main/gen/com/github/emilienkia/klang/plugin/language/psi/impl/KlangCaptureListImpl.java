...
public class KlangCaptureListImpl extends ASTWrapperPsiElement implements KlangCaptureList {

  public KlangCaptureListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangCapture> getCaptureList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangCapture.class);
  }
