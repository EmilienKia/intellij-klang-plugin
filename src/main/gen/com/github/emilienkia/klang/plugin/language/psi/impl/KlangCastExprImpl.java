...
public class KlangCastExprImpl extends ASTWrapperPsiElement implements KlangCastExpr {

  public KlangCastExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KlangUnaryExpr getUnaryExpr() {
    return findChildByClass(KlangUnaryExpr.class);
  }
