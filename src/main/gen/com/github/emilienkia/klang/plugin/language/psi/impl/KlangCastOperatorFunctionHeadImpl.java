...
public class KlangCastOperatorFunctionHeadImpl extends ASTWrapperPsiElement implements KlangCastOperatorFunctionHead {

  public KlangCastOperatorFunctionHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitCastOperatorFunctionHead(this);
  }
