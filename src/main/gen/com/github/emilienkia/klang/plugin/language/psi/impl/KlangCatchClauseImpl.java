...
public class KlangCatchClauseImpl extends ASTWrapperPsiElement implements KlangCatchClause {

  public KlangCatchClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KlangCatchParameterDecl getCatchParameterDecl() {
    return findNotNullChildByClass(KlangCatchParameterDecl.class);
  }
