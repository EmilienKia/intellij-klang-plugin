...
public class KlangCondVarInitialiserImpl extends ASTWrapperPsiElement implements KlangCondVarInitialiser {

  public KlangCondVarInitialiserImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitCondVarInitialiser(this);
  }
