...
public class KlangDesignatedInitElementImpl extends ASTWrapperPsiElement implements KlangDesignatedInitElement {

  public KlangDesignatedInitElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitDesignatedInitElement(this);
  }
  ...
  @Override
  @NotNull
  public KlangDesignatedMemberName getDesignatedMemberName() {
    return findNotNullChildByClass(KlangDesignatedMemberName.class);
  }
