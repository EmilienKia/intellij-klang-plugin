...
public class KlangDestructorHeadImpl extends ASTWrapperPsiElement implements KlangDestructorHead {

  public KlangDestructorHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitDestructorHead(this);
  }
