...
public class KlangEqualityExprImpl extends ASTWrapperPsiElement implements KlangEqualityExpr {

  public KlangEqualityExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangRelationalExpr> getRelationalExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangRelationalExpr.class);
  }
