...
public class KlangExpressionListImpl extends ASTWrapperPsiElement implements KlangExpressionList {

  public KlangExpressionListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangAssignmentExpr> getAssignmentExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangAssignmentExpr.class);
  }
