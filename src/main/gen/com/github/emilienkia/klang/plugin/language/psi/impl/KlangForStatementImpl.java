...
public class KlangForStatementImpl extends ASTWrapperPsiElement implements KlangForStatement {

  public KlangForStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangExpression> getExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangExpression.class);
  }
