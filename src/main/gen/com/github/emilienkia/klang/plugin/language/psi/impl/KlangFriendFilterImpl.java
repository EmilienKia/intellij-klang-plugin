...
public class KlangFriendFilterImpl extends ASTWrapperPsiElement implements KlangFriendFilter {

  public KlangFriendFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitFriendFilter(this);
  }
