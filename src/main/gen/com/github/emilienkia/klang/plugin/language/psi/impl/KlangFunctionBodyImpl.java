...
public class KlangFunctionBodyImpl extends ASTWrapperPsiElement implements KlangFunctionBody {

  public KlangFunctionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KlangTypeSpecList getTypeSpecList() {
    return findChildByClass(KlangTypeSpecList.class);
  }
