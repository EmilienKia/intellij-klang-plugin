...
public class KlangFunctionRefQualifierImpl extends ASTWrapperPsiElement implements KlangFunctionRefQualifier {

  public KlangFunctionRefQualifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitFunctionRefQualifier(this);
  }
