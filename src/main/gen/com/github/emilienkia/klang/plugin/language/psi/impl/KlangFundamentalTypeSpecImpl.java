...
public class KlangFundamentalTypeSpecImpl extends ASTWrapperPsiElement implements KlangFundamentalTypeSpec {

  public KlangFundamentalTypeSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitFundamentalTypeSpec(this);
  }
