...
public class KlangGenericDeclarationImpl extends ASTWrapperPsiElement implements KlangGenericDeclaration {

  public KlangGenericDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
