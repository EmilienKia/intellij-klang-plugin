...
public class KlangIdentifierSegmentImpl extends ASTWrapperPsiElement implements KlangIdentifierSegment {

  public KlangIdentifierSegmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitIdentifierSegment(this);
  }
