...
public class KlangIfCondVarDeclImpl extends ASTWrapperPsiElement implements KlangIfCondVarDecl {
  ...
  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitIfCondVarDecl(this);
  }
  ...
  @Override
  @Nullable
  public KlangCondVarInitialiser getCondVarInitialiser() {
    return findChildByClass(KlangCondVarInitialiser.class);
  }
