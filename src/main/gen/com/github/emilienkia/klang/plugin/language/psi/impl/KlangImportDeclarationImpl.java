...
public class KlangImportDeclarationImpl extends ASTWrapperPsiElement implements KlangImportDeclaration {

  public KlangImportDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
