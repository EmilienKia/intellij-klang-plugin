...
public class KlangInitElementImpl extends ASTWrapperPsiElement implements KlangInitElement {

  public KlangInitElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitInitElement(this);
  }
