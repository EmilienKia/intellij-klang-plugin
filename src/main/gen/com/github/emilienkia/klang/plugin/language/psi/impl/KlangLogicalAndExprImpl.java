...
public class KlangLogicalAndExprImpl extends ASTWrapperPsiElement implements KlangLogicalAndExpr {

  public KlangLogicalAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangInclusiveBinOrExpr> getInclusiveBinOrExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangInclusiveBinOrExpr.class);
  }
