...
public class KlangMemberInitListImpl extends ASTWrapperPsiElement implements KlangMemberInitList {

  public KlangMemberInitListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitMemberInitList(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangMemberInit> getMemberInitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangMemberInit.class);
  }
