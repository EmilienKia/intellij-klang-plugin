...
public class KlangNamedReturnInitImpl extends ASTWrapperPsiElement implements KlangNamedReturnInit {

  public KlangNamedReturnInitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitNamedReturnInit(this);
  }
