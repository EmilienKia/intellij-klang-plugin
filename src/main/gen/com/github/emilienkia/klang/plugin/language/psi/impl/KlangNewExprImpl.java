...
public class KlangNewExprImpl extends ASTWrapperPsiElement implements KlangNewExpr {

  public KlangNewExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KlangTypeName getTypeName() {
    return findNotNullChildByClass(KlangTypeName.class);
  }
