...
public class KlangParameterListImpl extends ASTWrapperPsiElement implements KlangParameterList {

  public KlangParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangParameterSpec> getParameterSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangParameterSpec.class);
  }
