...
public class KlangPmExprImpl extends ASTWrapperPsiElement implements KlangPmExpr {

  public KlangPmExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitPmExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangCastExpr> getCastExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangCastExpr.class);
  }
