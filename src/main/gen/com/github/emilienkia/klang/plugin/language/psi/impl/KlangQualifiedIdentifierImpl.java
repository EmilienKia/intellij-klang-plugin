...
public class KlangQualifiedIdentifierImpl extends ASTWrapperPsiElement implements KlangQualifiedIdentifier {
  ...
  @Override
  @NotNull
  public List<KlangIdentifierSegment> getIdentifierSegmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangIdentifierSegment.class);
  }
