...
public class KlangShiftingExprImpl extends ASTWrapperPsiElement implements KlangShiftingExpr {

  public KlangShiftingExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitShiftingExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangAdditiveExpr> getAdditiveExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangAdditiveExpr.class);
  }
