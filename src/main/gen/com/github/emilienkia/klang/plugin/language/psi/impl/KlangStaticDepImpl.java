...
public class KlangStaticDepImpl extends ASTWrapperPsiElement implements KlangStaticDep {

  public KlangStaticDepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitStaticDep(this);
  }
