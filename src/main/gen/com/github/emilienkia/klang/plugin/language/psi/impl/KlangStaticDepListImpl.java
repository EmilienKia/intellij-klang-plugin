...
public class KlangStaticDepListImpl extends ASTWrapperPsiElement implements KlangStaticDepList {

  public KlangStaticDepListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitStaticDepList(this);
  }
  ...
  @Override
  @NotNull
  public List<KlangStaticDep> getStaticDepList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangStaticDep.class);
  }
