...
public class KlangTemplateDeclarationImpl extends ASTWrapperPsiElement implements KlangTemplateDeclaration {

  public KlangTemplateDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KlangTemplateParameterList getTemplateParameterList() {
    return findNotNullChildByClass(KlangTemplateParameterList.class);
  }
