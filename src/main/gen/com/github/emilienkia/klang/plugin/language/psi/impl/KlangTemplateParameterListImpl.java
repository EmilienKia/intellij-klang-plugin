...
public class KlangTemplateParameterListImpl extends ASTWrapperPsiElement implements KlangTemplateParameterList {

  public KlangTemplateParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangTemplateParameter> getTemplateParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangTemplateParameter.class);
  }
