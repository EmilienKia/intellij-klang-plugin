...
public class KlangTemplateQualifiedScopeExprImpl extends ASTWrapperPsiElement implements KlangTemplateQualifiedScopeExpr {

  public KlangTemplateQualifiedScopeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitTemplateQualifiedScopeExpr(this);
  }
  ...
  public KlangTemplateArgList getTemplateArgList() {
    return findNotNullChildByClass(KlangTemplateArgList.class);
  }
