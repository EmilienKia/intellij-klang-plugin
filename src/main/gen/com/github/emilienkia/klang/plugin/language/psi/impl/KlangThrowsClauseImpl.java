...
public class KlangThrowsClauseImpl extends ASTWrapperPsiElement implements KlangThrowsClause {

  public KlangThrowsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangTypeSpec> getTypeSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangTypeSpec.class);
  }
