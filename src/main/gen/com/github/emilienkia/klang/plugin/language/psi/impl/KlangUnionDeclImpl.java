...
public class KlangUnionDeclImpl extends KlangNamedDeclMixin implements KlangUnionDecl {

  public KlangUnionDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KlangUnionMemberDecl> getUnionMemberDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KlangUnionMemberDecl.class);
  }
