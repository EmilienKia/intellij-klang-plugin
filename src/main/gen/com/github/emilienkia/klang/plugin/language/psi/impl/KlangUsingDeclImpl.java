...
public class KlangUsingDeclImpl extends ASTWrapperPsiElement implements KlangUsingDecl {

  public KlangUsingDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KlangUsingFilter getUsingFilter() {
    return findChildByClass(KlangUsingFilter.class);
  }
