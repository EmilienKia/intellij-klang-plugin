...
public class KlangUsingFilterImpl extends ASTWrapperPsiElement implements KlangUsingFilter {

  public KlangUsingFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitUsingFilter(this);
  }
