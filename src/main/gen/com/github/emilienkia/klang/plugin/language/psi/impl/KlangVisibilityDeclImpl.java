...
public class KlangVisibilityDeclImpl extends ASTWrapperPsiElement implements KlangVisibilityDecl {

  public KlangVisibilityDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KlangVisitor visitor) {
    visitor.visitVisibilityDecl(this);
  }
