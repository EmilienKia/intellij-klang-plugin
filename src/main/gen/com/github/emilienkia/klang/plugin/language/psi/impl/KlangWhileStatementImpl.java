...
public class KlangWhileStatementImpl extends ASTWrapperPsiElement implements KlangWhileStatement {

  public KlangWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KlangExpression getExpression() {
    return findNotNullChildByClass(KlangExpression.class);
  }
